        ...
        <header className="cabecera">
            <div className="cabecera-contenedor">
                <div className="cabecera-logo">
                    <img src={logo} alt="Logo empresa" height="60" />
                </div>
                <nav className="cabecera-menu">
                    <ul className="cabecera-menu-contenedor">
                        ...
                        <li className="cabecera-menu-item">
                            <Link to="/ventas-registrar" className="cabecera-menu-link">Ventas</Link>
                        </li>
                        <li className="cabecera-menu-item">
                            <Link to="/productos-buscar" className="cabecera-menu-link">producto</Link>  
                        </li>  
                        <li className="cabecera-menu-item">
